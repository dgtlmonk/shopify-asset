...
var app = (function () {
    ...
    socket.on("perkd:hooks", (payload) => {
        const { data } = payload;
        console.log("perkd-hooks received ", data);
        if (window["__perkd__init__"]) {
            // @ts-ignore
            console.log("[SOCKET CLIENT]  Perkd init vars ", window.__perkd__init__);
            // @ts-ignore
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(/*toggleText*/ ctx[0]);
    			attr_dev(button, "class", "shadow-lg border  bg-white tracking-normal rounded-lg  p-2 m-2");
    			add_location(button, file, 18, 0, 269);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*toggleWidget*/ ctx[1], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*toggleText*/ 1) set_data_dev(t1, /*toggleText*/ ctx[0]);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function toggleWidget() {
    		$$invalidate(2, isHidden = !isHidden);
    	...
    	$$self.$inject_state = $$props => {
    		if ("isHidden" in $$props) $$invalidate(2, isHidden = $$props.isHidden);
    		if ("toggleText" in $$props) $$invalidate(0, toggleText = $$props.toggleText);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*isHidden*/ 4) {
    			$$invalidate(0, toggleText = isHidden ? "x" : "Rewards");
    		}
    	};

    	return [toggleText, toggleWidget, isHidden];
    }
    ...
    const app = new App({
        target: document.getElementById("perkd-rewards-widget"),
    });
