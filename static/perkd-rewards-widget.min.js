...
var app = (function () {
    ...
    socket.on("perkd:hooks", (data) => {
        console.log("perkd-hooks received ", data);
        if (window["__perkd__init__"]) {
            // @ts-ignore
            console.log(" perked init from socket client ", window.__perkd__init__);
        }
    });
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "shadow-md border rounded-lg p-2 m-2");
    			add_location(button, file, 19, 0, 315);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", triggerDiscount, false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    const btnText = "Rewards";

    function triggerDiscount() {
    	console.log("discount triggered");
    } // fetch('http://local-perkd-development.myshopify.com/discount/S1P17E5JD7X1', {
    // 	method: 'GET'
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Tailwind, btnText, triggerDiscount });
    	return [];
    }
