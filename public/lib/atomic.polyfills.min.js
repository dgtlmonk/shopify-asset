...
!(function (t, e) {
  ...
  function C(e, n, r) {
    n.constructor === e.constructor && r === w && n.constructor.resolve === b
      ? (function (t, e) {
          e._state === j
            ? M(t, e._result)
            : e._state === x
  ...
  function P(t, e) {
    var n, r;
    t === e
      ? q(t, new TypeError("You cannot resolve a promise with itself"))
      : ((r = typeof (n = e)),
  ...
  function M(t, e) {
    t._state === T &&
      ((t._result = e), (t._state = j), 0 !== t._subscribers.length && i(F, t));
  }
  function q(t, e) {
    t._state === T && ((t._state = x), (t._result = e), i(E, t));
  }
  function R(t, e, n, r) {
  ...
  function N(e, n, r, o) {
    ...
    n._state !== T ||
      (i && a ? P(n, s) : c ? q(n, u) : e === j ? M(n, s) : e === x && q(n, s));
  }
  var H = 0;
  function J(t) {
    (t[g] = H++),
  ...
  var L = (function () {
    ...
    return (
      ...
      (t.prototype._settledAt = function (t, e, n) {
        var r = this.promise;
        r._state === T &&
          (this._remaining--, t === x ? q(r, n) : (this._result[e] = n)),
  ...
  (function (t, e) {
    ...
    function (t) {
        ...
        o = function (t) {
          var n = new XMLHttpRequest(),
            r = new Promise(function (r, o) {
              ...
              n.open(e.method, t, !0, e.username, e.password),
              (n.responseType = e.responseType),
              e.headers))
                e.headers.hasOwnProperty(i) &&
                  n.setRequestHeader(i, e.headers[i]);
              e.timeout &&
                ((n.timeout = e.timeout),
                (n.ontimeout = function (t) {
                  o({ status: 408, statusText: "Request timeout" });
                })),
                ...
                n.send(
                  (function (t) {
                    if (
                      "string" == typeof t ||
                      "[object FormData]" === Object.prototype.toString.call(t)
                    )
                      return t;
                    if (
                      /application\/json/i.test(e.headers["Content-type"]) ||
      ...
      return function (i, s) {
        if (!("XMLHttpRequest" in t && "JSON" in t && "Promise" in t))
